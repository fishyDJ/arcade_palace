...
# Initialize Pygame
pygame.init()
bg_img = pygame.image.load("wanderandponder\Assets\mapforwanderandponder.png")
cat = pygame.image.load("wanderandponder\\Assets\\blackcat.png")
burp = pygame.image.load("wanderandponder\Assets\glowpurpleball.png")
